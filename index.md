...
>#### Обязательно сообщите идентификатор (номенклатуру) самостоятельно выбранного вами для работы тайла личным сообщением преподавателю в&nbsp;**MS&nbsp;Teams** или в **Яндекс Мессенджер**.
...
Вращая 3D&#8209;модель, убедитесь, что высота ее боковых сторон вас устраивает, после чего нажмите&nbsp;кнопку «**ОК**».
...
Если ULR&#8209;ссылку к сохраненному на вашем компьютере изображению вы формируете вручную (или&nbsp;редактируете html&#8209;заготовку) и для этого скопируете путь к файлу изображения
...
Для открытия созданной 3D&#8209;модели в браузере достаточно сделать здесь двойной щелчок мышью по индексному файлу «**index.html**». \
...
Переименуйте ваш сайт так, чтобы ссылка на него была более удобочитаемой и понятной, например, **`фамилия-территория`**. 
...
Имейте ввиду, что старая ссылка работать, разумеется, перестанет.
