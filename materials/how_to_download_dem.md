...
(это&nbsp;примерно 30&nbsp;метров в широтном направлении и в районе экватора). \
...
Обычно, как продукт, глобальные ЦМР представляет собой набор файлов, каждый из которых покрывает территорию размером 1° на 1°. В названии каждого файла содержатся координаты левого нижнего угла соответствующего ему покрытия.
...
<br>
После этого откроется форма авторизации, в которой требуется ввести «Имя&nbsp;пользователя» и «Пароль» (учетные данные), необходимые для загрузки ЦМР с портала **NASA&nbsp;Earthdata**.

![](../media/2024-09-18_03.png)

<br>
Для получения необходимых учетных данных, пройдите несложную регистрацию на портале **NASA&nbsp;Earthdata**, перейдя по ссылке
   <a href="https://urs.earthdata.nasa.gov/users/new"
      title="Ссылка на страницу регистрации на портале NASA Earthdata"
      target="_blank">
      <b>https://urs.earthdata.nasa.gov/users/new</b></a>.


>#### Обязательно сохраните данные о вашей регистрации (Login, Password и т.д.) в отдельный текстовый файл для последующего использования вами портала **NASA&nbsp;Earthdata**.
...
Размер распакованного hgt&#8209;файла составляет примерно 25 Мбайт.
<br><br>
>#### ***Важная рекомендация:***
> <i>При добавлении цифровой модели рельефа в ваш QGIS&#8209;проект перетягивайте на окно программы **именно распакованный** (то есть извлеченный из ZIP&#8209;архива) **hgt&#8209;файл** ЦМР, 
