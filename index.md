...
> Однако, к большому сожалению, иногда этот слой может загружаться крайне медленно, существенно затрудняя выполнение всей работы. \
> В таком случае, <u>вместо</u> слоя «Карта&nbsp;OpenTopoMap» используйте на всех последующих этапах работы слой «**Карта&nbsp;OSM&nbsp;Standard**».*
...
Каким образом можно загрузить необходимую вам для работы **цифровую модель рельефа**, прочитайте на отдельной [странице с подробной инструкцией](./materials/how_to_download_dem.html).
...
Для этого перетащите мышью на основное окно программы QGIS (на окно Карты) файл вашей ЦМР, скаченный вами ранее *(например, файл «Copernicus_DSM_COG_10_N55_00_E037_00_DEM.tif» с ЦМР GLO&#8209;30 
или файл «N37E027.hgt» с ЦМР SRTMGL1v003)*.
...
![](media/Пример рельефа без отмывки и с отмывкой.png)
