...
Легко найти и скачать файл необходимого вам тайла цифровой модели рельефа SRTMGL1v003 с портала NASA&nbsp;Earthdata можно с помощью удобного веб&#8209;сервиса **30&#8209;Meter SRTM Tile Downloader**, перейдя к нему по ссылке
...
Переместите ZIP&#8209;архив из папки «Загрузки» (Downloads) в вашу рабочую папку и извлеките из него в рабочую же папку hgt&#8209;файл с ЦМР.
...
С 2015 года загрубленная версия модели с пространственным разрешением в 1&quot; доступна для бесплатной загрузки после предварительной регистрации пользователя. \
Точность данных по высоте составляет около 5&nbsp;м, однако эта средняя оценка по всей площади суши не учитывает значительные погрешности в лесных зонах, обусловленные тем, 
