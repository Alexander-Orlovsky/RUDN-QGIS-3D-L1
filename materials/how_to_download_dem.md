---
layout: default
title: Что такое цифровая модель рельефа (ЦМР) и как ее загрузить
description: (дается краткое описание понятия цифровой модели рельефа; приводится информация об удобном варианте загрузки необходимой ЦМР)
...
Часто это становится возможным после несложной предварительной регистрации пользователя.
...
<br><br>
### Какую ЦМР предлагается использовать для работы и как ее можно загрузить
...
Файлы тайлов Copernicus Global DSM 30m в формате Cloud Optimized GeoTIFF (**COG**) хранятся в Amazon Simple Storage Service (Amazon&nbsp;**S3**) — облачной системе хранения 
в составе Amazon Web Services (AWS) и могут быть загружены по прямой ссылке.
...
> #### *Внимание !!!*
> *По состоянию на март 2026 года 25 (двадцать пять) COG&#8209;файлов тайлов GLO&#8209;30, обеспечивающих покрытие территории Армении и Азербайджана,
> в облачную систему хранения Amazon&nbsp;S3 остаются незагруженными. Расположение и номенклатуры этих тайлов представлены на схеме ниже:*

<br>
<img src="../media/Отсутствующие COG-тайлы на Армению и Азербайджан.png"
      alt="Нет фото"
      style="width:100%; border:1px solid #606c71;">

Если на эти тайлы ЦМР с разрешением 30&nbsp;м вам необходимы, но по указанной выше прямой ссылке скачать их не удается, 
то это означает, что в хранилище Amazon&nbsp;S3 они еще не&nbsp;добавлены. \
В этом случае, вместо ЦМР Copernicus Global DSM 30m используйте глобальную цифровую модель рельефа **SRTM** (NASA Shuttle Radar Topography Mission) версии **SRTMGL1v003**.

SRTM покрывает территорию, расположенную между **60°** северной широты и **56°** южной широты. \
Хотя это составляет около 80% всей суши Земли, важные северные территории планеты (включая обширные районы севера России) <u>данными SRTM не обеспечены</u>. \
*С подробным описанием ЦМР SRTM, а также особенностями и преимуществами ее версии&nbsp;3, можно ознакомиться на портале **NASA&nbsp;Earthdata** по 
   <a href="https://lpdaac.usgs.gov/products/srtmgl1v003" 
      title="Ссылка на сайт с описанием SRTMGL1v003" 
      target="_blank">
      ссылке</a>).*

Для загрузки нужного вам тайла SRTMGL1v003 перейдите по 
   <a href="https://step.esa.int/auxdata/dem/SRTMGL1" 
      title="Ссылка на сайт с ЦМР SRTMGL1v003" 
      target="_blank">
      <b>ссылке</b></a>. 
На открывшейся странице найдите поиском по номенклатуре тайла *(например, «N37E027»)* соответствующий ZIP&#8209;файл и кликните по нему левой клавишей мыши. \
После этого **ZIP&#8209;архив** с SRTM *(в моем примере это файл с именем «N37E027.SRTMGL1.hgt.zip»)* незамедлительно скачается в папку «**Загрузки**» (Downloads) на вашем компьютере.
...
Для загрузки необходимого ZIP&#8209;архива с файлом вашей ЦМР щелкните по соответствующей ссылке ПРАВОЙ (ИЛИ ЖЕ ЛЕВОЙ) ??? клавишей мыши 
